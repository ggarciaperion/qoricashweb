      ...
      <section style={{ background: '#ffffff' }} className="wsp-section py-16 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-10">
          <div className="wsp-outer-flex flex flex-row items-start gap-3 sm:gap-12 lg:gap-20">
            ...
            <div ref={wspMediaRef} className="wsp-phone-col order-1 flex items-start justify-start" style={{ flexShrink: 0, width: '36%', maxWidth: 420 }}>
              <div style={{ position: 'relative', width: '100%' }}>
                <img
                  src="/wsp.png"
                  alt="Opera por WhatsApp sin descargar ningún app"
                  className="wsp-img"
                  style={{ width: '100%', height: 'auto', maxHeight: 560, objectFit: 'contain', display: 'block', border: 'none', outline: 'none', background: 'transparent' }}
                />
            ...
            {/* Texto */}
            <div className="wsp-text-col flex-1 min-w-0 order-2 sm:pl-16 lg:pl-20">
