...
// Incluye los 25 departamentos del Perú con sus provincias y distritos principales
...
export const UBIGEO_DATA: { [key: string]: { [key: string]: string[] } } = {
  ...
  'Huánuco': {
    ...
    'Leoncio Prado': ['Rupa-Rupa', 'Daniel Alomía Robles', 'Hermilio Valdizan', 'José Crespo y Castillo', 'Luyando', 'Mariano Damaso Beraun', 'Pucayacu', 'Castillo Grande', 'Pueblo Nuevo', 'Santo Domingo de Anda'],
  ...
  'Ica': {
    ...
    'Nasca': ['Nazca', 'Changuillo', 'El Ingenio', 'Marcona', 'Vista Alegre'],
  ...
  'Lambayeque': {
    'Chiclayo': ['Chiclayo', 'Cayaltí', 'Chongoyape', 'Eten', 'Eten Puerto', 'José Leonardo Ortiz', 'La Victoria', 'Lagunas', 'Monsefú', 'Nueva Arica', 'Oyotún', 'Pátapo', 'Picsi', 'Pimentel', 'Pomalca', 'Pucalá', 'Reque', 'Santa Rosa', 'Saña', 'Tumán'],
