...
const FALLBACK_NOTICIAS: Noticia[] = [
  {
    id: 'h001',
    titulo: 'Sol estable en S/ 3.38: Fed de Warsh mantiene tasa en 3.50-3.75% y dotplot gira hawkish con 9 de 19 miembros anticipando alza en 2026',
    descripcion: 'El sol peruano cotiza en S/ 3.38 interbancario este lunes 22 de junio (compra S/ 3.3675 / venta S/ 3.3915 en banca), mostrando resiliencia pese al giro hawkish del FOMC del 17 de junio. La Fed mantuvo la tasa en 3.50-3.75% pero el dotplot elevó la mediana para fin de 2026 a 3.8%, con 9 de 19 miembros proyectando al menos una alza. El DXY avanzó a 100.8, su nivel más alto desde mayo 2025.',
    contenido: `El tipo de cambio PEN/USD inicia la semana del 22 de junio en S/ 3.38 interbancario — el nivel que el BCRP reporta como referencia oficial para hoy lunes. En el mercado bancario spot, las cotizaciones se ubican en S/ 3.3675 en compra y S/ 3.3915 en venta. El sol muestra notable estabilidad pese al entorno externo más hawkish generado por el FOMC del 17 de junio.

La Reserva Federal, en la primera reunión presidida por Kevin Warsh tras asumir como presidente de la Fed en reemplazo de Jerome Powell, votó 12-0 para mantener la tasa de fondos federales en 3.50%-3.75% por cuarta reunión consecutiva. La sorpresa fue el dotplot: la mediana de proyecciones para el fed funds rate a fin de 2026 subió de 3.4% a 3.8%, señalando que el comité ve necesario al menos una alza adicional este año. Nueve de los 19 participantes proyectan un incremento, ocho prevén sin cambios y solo uno anticipa un recorte.

El giro hawkish del dotplot responde a la revisión al alza en las perspectivas de inflación: los miembros del FOMC elevan la proyección de inflación PCE headline para 2026 a 3.6% (desde 2.7% en marzo) y el core a 3.3%. La presión inflacionaria responde principalmente a los precios de energía, que acumulan un alza superior al 23% interanual. El DXY Index avanzó a 100.8 puntos — su nivel más elevado desde mayo de 2025 — aunque lejos de los niveles que históricamente generan presión severa sobre el sol.

Para la semana, los mercados estarán atentos al PMI manufacturero flash (lunes) y el índice de confianza del consumidor Conference Board (martes). El BCRP mantiene reservas internacionales por encima de US$ 74 billones y su próxima reunión de política monetaria es el 10 de julio.`,
    analisis: `El sol en S/ 3.38 refleja la solidez de los fundamentos peruanos — agroexportaciones récord, producción minera en máximos históricos y reservas robustas — que compensan el endurecimiento del entorno externo post-FOMC. El DXY en 100.8 genera presión moderada, muy distinta a los niveles de 103-105 que históricamente han llevado al sol por encima de S/ 3.50.

Para empresas con operaciones de cambio planificadas, el rango actual S/ 3.38-3.40 representa un nivel favorable. Si el DXY continúa su avance y supera 102, podría verse presión adicional sobre el sol. En QoriCash ofrecemos el mejor tipo de cambio del mercado, sin comisiones y con atención inmediata.`,
    categoria: 'Internacional',
    fuente: 'CNBC / Fed Reserve',
  ...
  {
    id: 'h002',
    titulo: 'BCRP eleva proyección de crecimiento a 3.4% y prevé inflación de 3.8% a fin de 2026 en Reporte de Inflación de junio',
    descripcion: 'El Banco Central de Reserva del Perú publicó su Reporte de Inflación de junio 2026 elevando la proyección de crecimiento del PBI de 3.2% a 3.4%, impulsado por la mayor demanda interna y el dinamismo de los sectores no primarios. La inflación convergerá al rango meta hacia fines de 2026, cerrando el año en torno al 3.8%, por encima del límite superior del rango meta.',
    contenido: `El Banco Central de Reserva del Perú (BCRP) publicó el Reporte de Inflación de junio 2026, su documento trimestral de actualización de proyecciones macroeconómicas. La principal novedad es la revisión al alza del crecimiento del PBI para 2026 de 3.2% a 3.4%, sustentada en la mayor expansión de sectores no primarios con mayor valor agregado y el fortalecimiento de la demanda interna privada.

El presidente del BCRP, Julio Velarde, explicó en la presentación del reporte que el ajuste refleja "indicadores cíclicos que muestran mayor dinamismo de lo esperado en el primer semestre". Los sectores de mayor impulso son manufactura no primaria (+5.2%), comercio (+4.8%) y servicios (+4.1%). El sector primario, afectado por el fenómeno El Niño, arrastra una caída de 1.6% en el año, compensada parcialmente por la expansión minera.

En materia de inflación, el BCRP proyecta un cierre de 2026 en torno al 3.8%, por encima del límite superior del rango meta (3%), principalmente por el efecto rezagado de los precios de alimentos y energía. El banco central estima que la inflación retornará al rango meta de 1%-3% durante el primer semestre de 2027. La tasa de política monetaria se mantiene en 4.50% y el instituto emisor señaló que permanecerá vigilante para "asegurar la convergencia de la inflación al rango meta".

El reporte proyecta el tipo de cambio en el rango S/ 3.38-3.45 para el período 2026-2028, consistente con la cotización actual de S/ 3.38. Las reservas internacionales se mantienen por encima de US$ 74 billones — equivalentes al 30.6% del PBI estimado — lo que brinda al BCRP capacidad de intervención amplia ante episodios de volatilidad cambiaria.`,
    analisis: `La revisión al alza del crecimiento a 3.4% es una señal positiva sobre la resiliencia de la economía peruana. Perú mantiene uno de los perfiles macroeconómicos más sólidos de Latinoamérica: disciplina fiscal, reservas internacionales elevadas, deuda pública manejable y tipo de cambio estable en S/ 3.38.

La inflación en 3.8% por encima del rango meta implica que el BCRP no reducirá tasas en el corto plazo, lo que mantiene atractivos los rendimientos en soles para los inversores institucionales y favorece la demanda de moneda local. Para empresas que manejan flujos en dólares, este entorno sugiere estabilidad del sol en el rango S/ 3.38-3.42 durante el tercer trimestre. En QoriCash ofrecemos el mejor tipo de cambio del mercado para sus operaciones de cambio.`,
    categoria: 'Nacional',
    fuente: 'Gestión',
    fecha: '2026-06-22T08:00:00.000Z',
    destacada: true,
